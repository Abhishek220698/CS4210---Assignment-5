...
encoded_vals = []
#key vals bread : 0, wine : 1, eggs : 2, meat : 3, cheese : 4, pencil : 5, diaper : 6, bagel : 7, Milk : 8
for index, row in df.iterrows():
    ...
    labels = {'Bread' : val[0], 'Wine' : val[1], 'Eggs': val[2], 'Meat' : val[3], 'Cheese': val[4],'Pencil': val[5],
              'Diaper': val[6], 'Bagel': val[7], 'Milk' : val[8]}
